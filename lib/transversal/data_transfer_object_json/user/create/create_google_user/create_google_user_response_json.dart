...
class CreateGoogleUserResponseJson extends BaseResponseJson {
  UserDTO? userDTO;

  CreateGoogleUserResponseJson({
    required super.isSuccess,
    required String super.message,
    this.userDTO,
  });

  factory CreateGoogleUserResponseJson.fromJson(Map<String, dynamic> json) {
    return CreateGoogleUserResponseJson(
